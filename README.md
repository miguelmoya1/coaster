...
| `PWNED_PASSWORDS_ENABLED` | API       | Optional. Only `false` turns the Have I Been Pwned check off; unset leaves it on, and a service that will not answer lets the password through                                                                       |
