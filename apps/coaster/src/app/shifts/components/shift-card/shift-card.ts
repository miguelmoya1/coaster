...
@Component({
  ...
  host: {
    ...
    class: 'relative overflow-hidden bg-surface-container-high rounded-2xl p-5 flex items-center justify-between group active:scale-95 transition-all cursor-pointer block',
  },
