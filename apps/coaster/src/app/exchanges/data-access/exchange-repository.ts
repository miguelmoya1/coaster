...
export class ExchangeRepository {
  ...
  public readonly routes = {
    ...
    request: (barId: BarId, shiftId: ShiftId) =>
      `/bars/${barId}/shifts/${shiftId}/exchanges`,
    accept: (barId: BarId, exchangeId: ShiftExchangeId) =>
      `/bars/${barId}/exchanges/${exchangeId}/accept`,
  };
  ...
  public async accept(barId: BarId, exchangeId: ShiftExchangeId) {
    return firstValueFrom(
      this.#http
        .post<ShiftExchange>(this.routes.accept(barId, exchangeId), {})
        .pipe(map(exchangeMapper)),
    );
  }
}
