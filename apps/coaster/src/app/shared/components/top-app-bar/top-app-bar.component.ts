...
@Component({
  ...
  template: `
    ...
    >
      ...
      <div class="flex items-center gap-4">
        ...
        <button
          class="p-2 rounded-full hover:bg-surface-bright transition-colors active:scale-95 duration-200 text-on-surface-variant flex items-center justify-center cursor-pointer"
        >
  ...
  `,
  imports: [AvatarBadgeComponent, NgIcon],
