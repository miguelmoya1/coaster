        ...
        >
          @if (isListening()) {
            <div class="mb-1 flex items-center justify-center gap-1" aria-hidden="true">
              <span class="wave-establishment establishment-1"></span>
              <span class="wave-establishment establishment-2"></span>
              <span class="wave-establishment establishment-3"></span>
              <span class="wave-establishment establishment-4"></span>
              <span class="wave-establishment establishment-5"></span>
            </div>
          }
...
export class AiAssistantPanel {
  ...
  #dispatch() {
    ...
    if (!prompt || !activeEstablishmentId || this.service.status() === 'processing') {
      return;
    }
    ...
    this.draft.set('');
    this.service.send(activeEstablishmentId);
  }
}
