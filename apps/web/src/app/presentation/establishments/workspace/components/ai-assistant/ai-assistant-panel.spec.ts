...
describe('AiAssistantPanel', () => {
  ...
  describe('mobile sheet', () => {
    ...
    it('should float over the content without a backdrop so the establishment stays usable', () => {
  ...
  describe('composer', () => {
    ...
    it('should send what the user typed and clear the field', () => {
      ...
      expect(aiVoiceServiceMock.send).toHaveBeenCalledWith(asEstablishmentId('establishment-1'));
