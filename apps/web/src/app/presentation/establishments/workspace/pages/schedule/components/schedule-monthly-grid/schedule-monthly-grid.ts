...
@Component({
  selector: 'coaster-schedule-monthly-grid',
  ...
  template: `
    <div class="border border-outline-variant/10 bg-surface-container-low rounded-3xl p-4 flex flex-col gap-4">
      <div class="grid grid-cols-7 text-center border-b border-outline-variant/10 pb-2">
        <span class="text-xxs font-black text-on-surface-variant uppercase">{{ 'schedule.days.lun' | translate }}</span>
        <span class="text-xxs font-black text-on-surface-variant uppercase">{{ 'schedule.days.mar' | translate }}</span>
        <span class="text-xxs font-black text-on-surface-variant uppercase">{{ 'schedule.days.mie' | translate }}</span>
        <span class="text-xxs font-black text-on-surface-variant uppercase">{{ 'schedule.days.jue' | translate }}</span>
        <span class="text-xxs font-black text-on-surface-variant uppercase">{{ 'schedule.days.vie' | translate }}</span>
        <span class="text-xxs font-black text-on-surface-variant uppercase">{{ 'schedule.days.sab' | translate }}</span>
        <span class="text-xxs font-black text-on-surface-variant uppercase">{{ 'schedule.days.dom' | translate }}</span>
      </div>
...
export class ScheduleMonthlyGrid {
