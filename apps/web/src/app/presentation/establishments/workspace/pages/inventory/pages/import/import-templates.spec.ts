...
describe('ImportTemplates', () => {
  ...
  const templatesStoreMock = {
    ...
    importToEstablishment: vi.fn().mockResolvedValue({ err: null }),
  };
  ...
  it('should call importToEstablishment and reload stores on successful import', async () => {
    component.toggleCategory('cat-1');
    await component.importSelected();

    expect(templatesStoreMock.importToEstablishment).toHaveBeenCalledWith('establishment-123', ['cat-1']);
