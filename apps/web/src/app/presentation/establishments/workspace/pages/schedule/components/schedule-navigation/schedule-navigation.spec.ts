...
describe('ScheduleNavigation', () => {
  let component: ScheduleNavigation;
  let fixture: ComponentFixture<ScheduleNavigation>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ScheduleNavigation],
      providers: [provideTranslateService()],
    }).compileComponents();

    fixture = TestBed.createComponent(ScheduleNavigation);
  ...
  it('should emit viewChanged when a view mode segment is clicked', () => {
    ...
    const weekButton = Array.from(allButtons).find((btn) =>
      (btn as HTMLButtonElement).textContent?.includes('schedule.views.week'),
