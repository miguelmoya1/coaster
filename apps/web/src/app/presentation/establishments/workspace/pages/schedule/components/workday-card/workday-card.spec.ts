...
describe('WorkdayCard', () => {
  ...
  it('should drop the planned column when there is no shift for that day', () => {
    ...
    expect(fixture.nativeElement.textContent).not.toContain('schedule.time_tracking.planned');
  });
  ...
  it('should flag a mark that somebody corrected', () => {
    ...
    expect(fixture.nativeElement.textContent).toContain('schedule.time_tracking.badge_amended');
  ...
  it('should keep a voided mark on screen instead of hiding it', () => {
    ...
    expect(fixture.nativeElement.textContent).toContain('schedule.time_tracking.badge_voided');
