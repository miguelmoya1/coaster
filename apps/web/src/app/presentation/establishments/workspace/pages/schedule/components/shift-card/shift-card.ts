...
@Component({
  ...
  template: `
    ...
    <div class="flex flex-col flex-1 min-w-0">
      ...
      @if (!compact() && roleName() === EstablishmentRole.OWNER) {
    ...
    @if (compact()) {
      @if (hasPendingExchange()) {
        ...
        >
          {{ 'schedule.exchange_pending' | translate }}
        </span>
      } @else if (isOwn()) {
        <button
          mat-icon-button
          ...
          [attr.aria-label]="'schedule.offer_exchange' | translate"
          [matTooltip]="'schedule.offer_exchange' | translate"
      ...
      @if (isOwn()) {
        ...
        >
          ...
          @if (hasPendingExchange()) {
            ...
            {{ 'schedule.offer_exchange' | translate }}
          }
        </button>
      }
    }
