...
describe('ScheduleWeeklyGrid', () => {
  let component: ScheduleWeeklyGrid;
  let fixture: ComponentFixture<ScheduleWeeklyGrid>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ScheduleWeeklyGrid],
      providers: [provideTranslateService()],
    }).compileComponents();

    fixture = TestBed.createComponent(ScheduleWeeklyGrid);
  ...
  it('should hide the replicate and delete buttons from whoever cannot manage shifts', () => {
    ...
    const replicateBtn = Array.from(allButtons).find((btn) =>
      (btn as HTMLButtonElement).textContent?.includes('schedule.replication.button'),
    );
