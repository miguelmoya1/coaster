...
describe('ShiftCard', () => {
  ...
  beforeEach(async () => {
    ...
    fixture.componentRef.setInput('roleName', EstablishmentRole.OWNER);
  ...
  describe('rendering', () => {
    it('should display staff details and time range', () => {
      ...
      expect(element.textContent).toContain(EstablishmentRole.OWNER);
    ...
    it('should show exchange button if isOwn is true', () => {
      ...
      expect(button.textContent).toContain('schedule.offer_exchange');
    });
    ...
    it('should show pending text on button if hasPendingExchange is true', () => {
      ...
      const button = fixture.nativeElement.querySelector('button');
      expect(button.textContent).toContain('schedule.exchange_pending');
