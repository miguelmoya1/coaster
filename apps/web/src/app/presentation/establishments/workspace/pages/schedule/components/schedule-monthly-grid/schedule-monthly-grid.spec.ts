...
describe('ScheduleMonthlyGrid', () => {
  let component: ScheduleMonthlyGrid;
  let fixture: ComponentFixture<ScheduleMonthlyGrid>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ScheduleMonthlyGrid],
      providers: [provideTranslateService()],
    }).compileComponents();

    fixture = TestBed.createComponent(ScheduleMonthlyGrid);
