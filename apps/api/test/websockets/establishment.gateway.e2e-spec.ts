...
describe('EstablishmentGateway (e2e)', () => {
  ...
  it('should join an establishment room via joinEstablishment event', async () => {
    const establishmentId = 'test-establishment-123';

    socket.emit('joinEstablishment', establishmentId);
    ...
    expect(response).toBe(establishmentId);
  });

  it('should leave an establishment room via leaveEstablishment event', async () => {
    const establishmentId = 'test-establishment-123';

    socket.emit('leaveEstablishment', establishmentId);
