...
import { UpdateProductTemplateCommand } from '../impl/update-product-template.command';
...
describe('UpdateProductTemplateHandler', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [UpdateProductTemplateHandler, { provide: TemplatesWriteRepository, useValue: repository }],
    }).compile();
