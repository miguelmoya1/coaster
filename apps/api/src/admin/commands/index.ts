...
import { UpdateBarMemberRoleHandler } from './handlers/update-bar-member-role.handler';
...
export { UpdateBarMemberRoleCommand } from './impl/update-bar-member-role.command';

export const CommandHandlers = [
  GrantBarPlanHandler,
  RevokeBarPlanHandler,
  RenameBarHandler,
  UpdateBarMemberRoleHandler,
