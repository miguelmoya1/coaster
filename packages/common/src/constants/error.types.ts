export const ErrorCodes = {
  ...
  BETA_TESTER_ALREADY_EXISTS: 'BETA_TESTER_ALREADY_EXISTS',
  BETA_TESTER_NOT_FOUND: 'BETA_TESTER_NOT_FOUND',
  ...
  LAST_WAY_IN: 'LAST_WAY_IN',
  UNAUTHORIZED: 'UNAUTHORIZED',
  MISSING_ESTABLISHMENT_ID: 'MISSING_ESTABLISHMENT_ID',
  ...
  CANNOT_GRANT_OWNER_ROLE: 'CANNOT_GRANT_OWNER_ROLE',
  ...
  EXCHANGE_SHIFT_ALREADY_STARTED: 'EXCHANGE_SHIFT_ALREADY_STARTED',
  ...
  INVALID_ESTABLISHMENT_ID: 'INVALID_ESTABLISHMENT_ID',
  PRODUCT_NOT_FOUND: 'PRODUCT_NOT_FOUND',
  MENU_NOT_FOUND: 'MENU_NOT_FOUND',
  MENU_LANGUAGE_NOT_OFFERED: 'MENU_LANGUAGE_NOT_OFFERED',
  ...
  ORDER_IN_CASH_CLOSE: 'ORDER_IN_CASH_CLOSE',
  PRINTER_NOT_CONFIGURED: 'PRINTER_NOT_CONFIGURED',
  PRINTER_PAIRING_INVALID: 'PRINTER_PAIRING_INVALID',
  ...
  STRIPE_SUBSCRIPTION_SEATS_UPDATE_FAILED: 'STRIPE_SUBSCRIPTION_SEATS_UPDATE_FAILED',
  ...
  STRIPE_WEBHOOK_ESTABLISHMENT_ID_MISSING: 'STRIPE_WEBHOOK_ESTABLISHMENT_ID_MISSING',
