...
- [ ] **productos y categorias:**
  - [ ] Poner una sección para poner productos creados por defecto (Guardar en una tabla si ya se han importado o a lo mejor ver si existen en la db no dejar meterlos, poner un contador o comprobar si existe el producto en la db no permitir meterslo de nuevo (maybe un identificador))
